...
actual class GLContext actual constructor(val configuration: com.github.dwursteisen.minigdx.GLConfiguration) {
    ...
    actual fun run(gameFactory: () -> Game) {
        ...
        app.delegate = com.github.dwursteisen.minigdx.AppDelegate(
